...
ActiveRecord::Schema[7.1].define(version: 2024_11_02_080000) do
  ...
  create_table "battery_configurations", force: :cascade do |t|
    ...
    t.index ["moon_battery_id", "config_name"], name: "idx_on_moon_battery_id_config_name_27bcb44cee", unique: true
